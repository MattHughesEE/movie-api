...
aws cloudformation create-stack --region us-east-1 --stack-name $stack_name --template-url shttps://semaphore-test-app.s3.amazonaws.com/migrations/migrations-a729b7a44e820391b3499ad21f9eacf346465b44.zip